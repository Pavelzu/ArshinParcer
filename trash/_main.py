...
def savetoexcel(biglist,product,logger):
    header = getsheetheader(biglist)

    filename = "./results/" + product + "_" + dateplustime() + ".xlsx"
    ...
    logger.info('Записали в файл ' + filename)
...
def main():
    ...
    savetoexcel(grandinfolist,prodname,logger)
